    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                ...
                <h5 class="text-muted mb-3">Boarding facilities are places where pets stay overnight while their owners are away.</h5>
                <p class="mb-4">Daycare facilities provide a place for pets to socialize, play, and receive care during the day while their owners are at work or otherwise engaged.</p>
            ...
            <div class="row pb-3">
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <h3 class="mb-3">Taraswi J</h3>
                        <img src="img/team-1.jpg" alt="alternative_text">
                        <p>2100030203</p>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <h3 class="mb-3">Rasool Basha Shaik</h3>
                        <img src="img/team-2.jpg" alt="alternative_text">
                        <p>2100031395</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <h3 class="mb-3">Yamini Ch</h3>
                        <img src="img/team-3.jpg"  alt="alternative_text">
                        <p>2100032135</p>
                    </div>
                </div>
        </div>
