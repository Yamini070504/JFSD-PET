            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="bg-primary py-5 px-4 px-sm-5">
                        <form class="py-5" action="https://paytm.com/login">
                ...
                <div class="col-lg-7 py-5 py-lg-0 px-3 px-lg-5">
                    ...
                    <p>Each pet is unique, so consider selecting books that are specific to the type of pet you have and their individual needs.</p>
                    <div class="row py-2">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex flex-column">
                                ...
                                <p class="m-0">Pet grooming is an important aspect of pet care that involves maintaining your pet's hygiene and appearance.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex flex-column">
                                ...
                                <p class="m-0">Training helps establish a strong bond between you and your pet and enhances their mental stimulation.</p>
                            </div>
                        </div>
                    </div>
                </div>
